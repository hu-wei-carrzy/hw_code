...
#include <PLF/source/PLFICU/LDB/LDB_ICU/LDB_ICU.h>
#include ".\..\..\TOS\TOS.h"
...
/*============================================================================
  ...
  DESIGN INFORMATION :  refer to Detailed Design Document
============================================================================*/
void LDBIcuReceiveWithoutAddr(tMsg* pMsg)
{
...
/*============================================================================
  ...
  DESIGN INFORMATION :  refer to Detailed Design Document
============================================================================*/
void LDBIcuReceiveWithAddr(tAddress addr, tMsg* pMsg)
{
...
/*============================================================================
  ...
  DESIGN INFORMATION :  refer to Detailed Design Document
============================================================================*/
void LDBIcuLeaveSleepMode(void)
{
...
/*============================================================================
  ...
  DESIGN INFORMATION :  refer to Detailed Design Document
============================================================================*/
void LDBIcuEnterSleepMode(void)
{
