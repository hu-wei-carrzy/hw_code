...
)
{
    ...
    clearnubNmBusOffCnt();  //add for busoff by william
    nmStatusTxCfm = NM_BIT_SET; //add for busoff by william
...
)
{
    ...
    {        
        ...
        if(NM_MODE_BUS_SLEEP == CanNm_Mode[nmChannelHandle])
        {
            ...
            /*[SWS_CanNm_00336]*/
	    //CANNM_SET_ACTIVE_WUB(nmChannelHandle) ;//WEIL
...
)
{
    ...
    else if(CANNM_NETWORK_REQUEST_CMD == cmd)
    {
        ...
        {
            /*[SWS_CanNm_00401]*/
            if(STD_ON == CANNM_ACTIVE_WU_BIT_ENABLED(nmChannelHandle))//&&(NM_LocalEvent_Ind == 1))
            {
...
/*[SWS_CanNm_00166]*/
    ...
    CANNM_START_NMTO_TIMER(nmChannelHandle);//WEIL
    /*[SWS_CanNm_00108]]*/
#if(CANNM_PASSIVE_MODE_ENABLED == STD_OFF)
    CanNm_MsgTxEnabled[nmChannelHandle] = STD_OFF;
    /*[SWS_CanNm_00051]*/
