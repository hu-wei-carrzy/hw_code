...
#define CANIF_DISPATCH_USERCTRLBUSOFF_DEFINED_NAME     CAN_BusOffHook(0);


#define CANIF_DISPATCH_USERSETWAKEUPEVENT_DEFINED_NAME CAN_WakeupHook()

/******************************************************************************
*    CANID6xx indication function Declare                                            
******************************************************************************/
extern void AppIpduCANID6xx_Ind(void);
