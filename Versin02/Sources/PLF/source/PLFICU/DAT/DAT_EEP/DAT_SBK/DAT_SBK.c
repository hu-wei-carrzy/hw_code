...
void DATSbkInit (void)
{
    ...
    DatSbk_CurrentNumberOfReadingRetry  = 0U;

    // Single Bank flags reset (not important)
    (void)mLIBmemset(SingleBankFlags, 0x00U, sizeof(SingleBankFlags));
}
...
BOOL DATSbkIsProcessing ( void )
{
    ...
    // Check all banks ...
    for (HandleSbk = 0U; HandleSbk < cNbSbk; HandleSbk++)
    {
...
void DATSbkCallBackEep ( tDATEepProcessHandle DATEepProcessHandle, BOOL DATEepCallBackStatusIsOk )
{
    ...
    case cChartState_Wait:
        ...
        if (mBankFlag_IsWriteMode(HandleSbk) == cTrue)
        {
            ...
            mLIBmemcpy ((U8 *) (DATEepBuffer + (U16)1U),
            ...
            DATEepBuffer[0] = Compute16BitsCheckSum (DATEepBuffer+1U, Sbk_SizeBlockRam);


            // Now, let's go for writing operation by the way of DAT_EEP
            DATEepWrite (DATEepBuffer, (tDATEepOffset)0U, (tDATEepOffset)(1U + Sbk_SizeBlockRam));
            ...
            ////////////////////////////////////////////////////
        {
            ...
            DATEepRead(DATEepBuffer, (tDATEepOffset)0U, (tDATEepOffset)(1U + Sbk_SizeBlockRam));
            // NOTA : "+1" is for the 16bits check-sum (at the top of the bank)
        }
    ...
    case cChartState_Reading:
        ...
        mLIBmemcpy ((U8 *) (Sbk_AddBlockRam),
                    (U8 *) (DATEepBuffer + (U16)1U), Sbk_SizeBlockRam * sizeof(U16));


        // Check the 16bits check-sum (locate at the bank'top) ...
        if (Compute16BitsCheckSum(DATEepBuffer + (U16)1U, Sbk_SizeBlockRam) == DATEepBuffer[0])
        {
        ...
        else  // Error detected, start "Compare" process
        {
            ...
            DATEepCompare(DATEepBuffer, (tDATEepOffset)0, (tDATEepOffset)(1U + Sbk_SizeBlockRam));
            // NOTA : "+1" is for the 16bits check-sum (at the top of the bank)
        }
