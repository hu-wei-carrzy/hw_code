...
#include ".\TOS_CONFIG\tosparam.h"
#include ".\TOS_SEQ\tos_seq.h"
#endif
//------------------------------------------------------------------------------
// Constant data
//------------------------------------------------------------------------------
...
#ifdef USE_TOS_SIG
extern void       TOSWriteSignal(const tTOSSignalID SignalId);
extern BOOL       TOSReadSignal(const tTOSSignalID SignalId);
#endif
