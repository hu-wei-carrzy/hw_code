...
/*
 * This macro used to turn on all the related code in dat_odo ldb_dfa and flash source code
 * to debug the DFA odometer issue.
 * 1 : Enabled, others : Disabled
 */
#define cfgDebugOdoIssue 0
...
typedef unsigned int    U1BF;
// The type REG defines the size of data registers of the micro.
#if (defined(cLIBStkFujitsuType_16Fx) || defined(cLIBStkFujitsuType_16FxS))
// (data registers of Fuji 16Fx are 16 bits wide.)
typedef U16 REG;  
#else
// the micro is not defined.
typedef unsigned int REG; // Warning: efficient for 16 and 32 bit MCUs, not for 8 bit!
#endif
...
//#ifndef DONT_KNVM_OLD_TYPE_COMPATIBILITY
...
//Semaphore type...
typedef BOOL tSemaphore;
//Resource message text pointer type...
typedef   U16* tResourceTextPtr;

//Resource bitmap pointer type...
typedef   U8* tResourceBitmapPtr;

//Generic resource pointer type...
typedef  void* tResourcePtr;
