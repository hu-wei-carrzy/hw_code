...
rem .\..\..\XXX\YYY\LAP\LAP_SUP\LAP_SUP.JIL
rem  here should clear all file in SCC2Gen folder
echo now first delete all files in SCC2Gen 
rd /s/q .\..\..\XXX\YYY\SCC2Gen\

echo after delete files, now begin SCC2 Analysis......

.\SCC2\SCC2.EXE  .\CollectJIL\LAP_SUP.jil -OUT:.\..\..\XXX\YYY\SCC2Gen\GEN -G:.\SCC2\ -Int -DUMP:.\..\..\..\XXX\YYY\SCC2Gen\DB.JIL
.\SCC2\SCC2.EXE  .\CollectJIL\LAP_SUP.jil -OUT:.\..\..\XXX\YYY\SCC2Gen\GENSIMU -G:.\SCC2\ -Simu
del .\CollectJIL\*.jil
del .\CollectJIL\*.h
del .\..\..\XXX\YYY\SCC2Gen\GENSIMU\*.cpp
